...
export function CalculatorsPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-white-0 relative">
      ...
      <main className="flex-1 overflow-y-auto relative z-10">
        <ActiveComponent />
        {/* Disclaimer */}
        <div data-theme="dark" className="px-6 py-5 border-t border-sb-3 bg-dark-0 relative">
