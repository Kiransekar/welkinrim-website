...
export function CalculatorsPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-sb-0">
      <CalcSidebar activeId={activeCalc} onSelect={setActiveCalc} />
      <main className="flex-1 overflow-y-auto">
        <ActiveComponent />
        {/* Disclaimer */}
        <div className="px-6 py-4 border-t border-sb-3 bg-sb-0">
          <p className="font-mono text-[8px] tracking-[0.06em] text-[rgba(255,255,255,0.22)] italic leading-[1.6] max-w-[600px]">
